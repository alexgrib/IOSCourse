...
class TaskTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        background.layer.shadowColor = #colorLiteral(red: 0.6101596951, green: 0.1539793909, blue: 0.6897916198, alpha: 1).cgColor
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        if selected {
            background.tintColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        } else {
